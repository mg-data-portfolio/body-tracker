...
export default function App() {
  ...
  // The number the user follows: locked target while a cycle is mid-flight, else the formula target
  const target = (cycle && !reviewDue) ? cycle.lockedTarget : formulaTarget;
